...
public class Knight extends ChessPieceBase implements ChessPiece {
    ...
    public boolean canMove(Chessboard chessboard, Square destination) {
        ...
        if (chessboard.getPieceAt(destination) == null) {
            ...
            if ((destination.getX() == location.getX() - 1) || (destination.getX() == location.getX() + 1) && (location.getY() == destination.getY() - 2) || (location.getY() == destination.getY() - 2)) {
                return true;
            } else if ((destination.getX() == location.getX() - 2) || (destination.getX() == location.getX() + 2) && (location.getY() == destination.getY() - 1) || (location.getY() == destination.getY() - 1)) {
                return true;
            }
