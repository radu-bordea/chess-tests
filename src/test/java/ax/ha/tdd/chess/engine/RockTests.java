...
import ax.ha.tdd.chess.engine.pieces.Rock;
...
public class RockTests {
    ...
    @Test
    public void testWhiteRockForward(){

        Chessboard chessboard = new ChessboardImpl();
        Rock a1 = new Rock(Player.WHITE, new Square("a1"));
        assertTrue(a1.canMove(chessboard, new Square("a7")));
    }
